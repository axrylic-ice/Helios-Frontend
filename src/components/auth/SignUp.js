      ...
      <div className="absolute left-4 right-4 top-6 flex items-center justify-between z-30 md:left-6 md:top-8 md:justify-start md:gap-3">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col justify-center">
            <div className="text-[#C29241] font-bold text-[16px] md:text-[20px] leading-none tracking-[-1px]">Fotuna</div>
            <div className="hidden xs:block text-[#F6F3EA]/60 text-[7px] md:text-[10px] uppercase tracking-[1px] mt-1">FX Decision Intelligence</div>
          </div>
        </Link>
      ...
      >
        <div className="w-full max-w-[420px] flex flex-col gap-6 md:gap-8">
          <div className="text-center md:text-left">
            <h1 className="text-white text-[28px] xs:text-[32px] md:text-[42px] font-semibold tracking-tight mb-2">Get Started</h1>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex justify-between items-center px-1">
        <label className="text-white/40 text-[10px] md:text-[11px] uppercase tracking-widest font-bold">{label}</label>
        {error && <span className="text-red-500 text-[9px] md:text-[10px] uppercase font-black">{error}</span>}
      </div>
