      ...
      >
        ...
        <AnimatePresence>
          {showTooltip && (
            ...
            >
              <div className="relative bg-[#F3BE68] text-black text-[10px] font-black px-4 py-2 rounded-xl shadow-2xl whitespace-nowrap">
                Click for more info
                <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[5px] border-l-transparent border-r-[5px] border-r-transparent border-t-[5px] border-t-[#F3BE68]" />
              </div>
            </motion.div>
          )}
        </AnimatePresence>
