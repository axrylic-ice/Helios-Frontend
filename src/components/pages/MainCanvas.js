...
const MainCanvas = () => {
  ...
  return (
    <div className="w-full min-h-screen p-2 md:p-2 flex flex-col gap-6 md:gap-8 font-['Inter'] text-[#D3C4B2]">
      {/* Header Section */}
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-4">
        ...
        <button className="group w-full md:w-auto flex flex-row items-center justify-center px-6 py-3 gap-2 bg-[#222121]/50 border border-white/5 rounded-full hover:bg-[#2A2A2A] hover:border-[#F3BE68]/50 active:scale-95 transition-all duration-300">
              ...
              {[1, 2, 3].map((row) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 text-right">
                    <button className="text-[#F3BE68] text-xs uppercase tracking-wider hover:text-white transition-colors underline underline-offset-4">
                      Verify
                    </button>
                  </td>
                </tr>
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
            ...
            <tbody className=" text-sm text-[#E5E2E1]">
              <tr className="hover:bg-white/[0.02] transition-colors group">
                ...
                <td className="px-6 py-4  font-bold text-[#F3BE68]">
                  0.84221.99
                </td>
                <td className="px-6 py-4 text-right font-mono text-xs">14ms</td>
              </tr>
              <tr className="border-t border-[rgba(79,69,56,0.3)] hover:bg-white/[0.02] transition-colors group">
                <td className="px-6 py-4 opacity-50 group-hover:opacity-100 transition-opacity">
                  2026.04.26 : 11:58
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4  font-bold text-[#43E188]">
                  MARKET_NEUTRAL
                </td>
                <td className="px-6 py-4 text-right font-mono text-xs">32ms</td>
              </tr>
              <tr className="border-t border-[rgba(79,69,56,0.3)] hover:bg-white/[0.02] transition-colors group">
                <td className="px-6 py-4 opacity-50 group-hover:opacity-100 transition-opacity">
                  2026.04.26 : 11:45
                ...
                <td className="px-6 py-4">
                  <TableStatus type="error" text="FAILED" />
                </td>
                <td className="px-6 py-4 font-normal text-[#D3C4B2]">
                  Poly_Bayes_Ref
                </td>
                <td className="px-6 py-4  font-bold text-[#737373]">
                  NULL_SIG_DET
                </td>
                <td className="px-6 py-4 text-right font-mono text-xs">--</td>
              </tr>
            </tbody>
          </table>
        </div>
...
/* --- PROGRESS COMPONENT (Inlined for standalone utility) --- */
